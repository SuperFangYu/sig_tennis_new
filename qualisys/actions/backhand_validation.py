"""反手：修改下方三条输入路径后，在 PyCharm 直接运行本文件。"""
...
VIDEO_PATH = REPO_ROOT / "qualisys/data/input/video/fy_fs_1.avi"
RTMPOSE_CSV_PATH = REPO_ROOT / "qualisys/data/input/rtmpose/fy_fs_1.csv"
QUALISYS_TSV_PATH = REPO_ROOT / "qualisys/data/input/qtm/fy_fs_1.tsv"
