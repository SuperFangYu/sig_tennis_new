"""反手截击：修改下方三条输入路径后，在 PyCharm 直接运行本文件。"""
...
VIDEO_PATH = REPO_ROOT / "qualisys/data/input/video/fy_jjfs_1.avi"
RTMPOSE_CSV_PATH = REPO_ROOT / "qualisys/data/input/rtmpose/fy_jjfs_1.csv"
QUALISYS_TSV_PATH = REPO_ROOT / "qualisys/data/input/qtm/fy_jjfs_1.tsv"
